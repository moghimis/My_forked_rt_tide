...
filenameB = '../inp/wl_8656483_Beaufort_NC/data.nc'
ncf=netCDF4.Dataset(filenameB)
ncvar=ncf.variables
time      = ncvar['time']
time_unit = time.units
utime     = netcdftime.utime(time.units)
...
########################################################
filenameW = '../inp/wl_8658163_Wrightsville_Beach_NC/data.nc'
ncf=netCDF4.Dataset(filenameW)
ncvar=ncf.variables
time      = ncvar['time']
time_unit = time.units
utime       = netcdftime.utime(time.units)
...
if False:
    dates_obs     = date_beau
    elevation_obs = elev_beau
    lat1          = lat_beau 
    lon1          = lon_beau
    filename2     = filenameB
else:
    dates_obs     = date_wrig
    elevation_obs = elev_wrig
    lat1          = lat_wrig 
    lon1          = lon_wrig
    filename2     = filenameW


print lat1,lon1,filename2
########################################################3
#!/usr/bin/env python
