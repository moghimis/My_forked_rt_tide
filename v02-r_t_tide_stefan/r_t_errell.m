function [emaj,emin,einc,epha]=r_t_errell(cxi,sxi,ercx,ersx,ercy,ersy,varargin)
% [emaj,emin,einc,epha]=r_t_errell(cx,sx,cy,sy,ercx,ersx,ercy,ersy) computes
...
% ################################################################
% Save test data
if savetestdata && ~r_t_errell_saved
    
    r_t_errell_saved = true;
    % [emaj,emin,einc,epha]
    outvals.emaj = emaj;
    outvals.emin = emin;
    outvals.einc = einc;
    outvals.epha = epha;
    writetestdata('r_t_errell',invals,outvals);
