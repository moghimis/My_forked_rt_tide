...
% option to r_t_tide.  You can get the names and frequencies of 
...
% 
% Note that r_t_tide has options for pretty much anything you could 
% possibly want to do -  type 'help r_t_tide' for more info (also look 
...
%
% ---FOR ANALYSIS
% r_t_tide.m       - computes the tidal analysis of the real or complex 
%                  time series.
%
% r_t_predic.m     - computes a tidal prediction using the results of 
%                  r_t_tide.
%
% r_t_vuf.m        - computes nodal corrections. 
% 
% r_t_astron.m     - computes astronomical arguments.
%
% r_t_getconsts.m  - loads constituent data of all kinds (based on the 
%                  data file from the fortran package).
%
% r_t_xtide.m      - worldwide tidal predictions using the constituent data
...
% ---FOR DEMONSTRATION
%
% r_t_synth.m      - synthesizes noisy data to test real as opposed to
...
% ---FOR FUN
%
% r_t_equilib.m    - computes the equilibrium amplitudes of main
...
%                  various data structures in r_t_constituents.mat)
%
% r_t_equilib.dat  - equilibrium amplitude A and B factors. (read once 
%                  and results then stored in r_t_constituents.mat)
%
% r_t_constituents.mat - constituent data structures.
%
